    ...
    public partial class st_registration_form : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void btn_st_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt_st_name.Text != "" && txt_st_lname.Text != "" && txt_st_father_name.Text != "" && txt_father_id.Text != "" && txt_st_email.Text != "" && txt_st_mobile.Text != "" && cmb_st_class.Text != "" && txt_st_address.Text != "" && cmb_country.Text != "" && cmb_province.Text != "" && cmb_city.Text != "")
                {
                    cmd = new SqlCommand("insert into studentdata values('" + txt_st_name.Text + "','" + txt_st_lname.Text + "','" + txt_st_father_name.Text + "','" + txt_father_id.Text + "','" + txt_st_email.Text + "','" + txt_st_mobile.Text + "','" + date_of_birth.Text + "','" + date_of_registration.Text + "','" + classid + "','" + txt_st_address.Text + "','" + gender + "','" + countryid + "','" + provinceid + "','" + cityid + "')", con.opencon());
                    cmd.ExecuteNonQuery();
        ...
        private void btn_st_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt_st_name.Text != "" && txt_st_lname.Text != "" && txt_st_father_name.Text != "" && txt_father_id.Text != "" && txt_st_email.Text != "" && txt_st_mobile.Text != "" && cmb_st_class.Text != "" && txt_st_address.Text != "" && cmb_country.Text != "" && cmb_province.Text != "" && cmb_city.Text != "")
                {
                    cmd = new SqlCommand("update studentdata set FName='" + txt_st_name.Text + "',LName='" + txt_st_lname.Text + "',FatherName='" + txt_st_father_name.Text + "',FatherID='" + txt_father_id.Text + "',Email='" + txt_st_email.Text + "', Mobile='" + txt_st_mobile.Text + "',DOB='" + DOB_Student + "',DOR='" + DOR_Student + "',Cls_id='" + st_class_id + "',Adress='" + txt_st_address.Text + "',gender='" + gender + "',c_id='" + st_country_id + "',p_id='" + st_prov_id + "', ct_id='" + st_cty_id + "' where Student_id='" + st_data_display.St_id + "'", con.opencon());
                    cmd.ExecuteNonQuery();
