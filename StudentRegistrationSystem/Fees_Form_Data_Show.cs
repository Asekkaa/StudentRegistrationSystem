...
namespace StudentRegistrationSystem
{
    public partial class Fees_Form_Data_Show : MaterialSkin.Controls.MaterialForm
    {
        ...
        {
            adpt = new SqlDataAdapter("select fees_Form.F_ID,studentdata.FName, studentclass.Class_Name,StudentMonths.Months, fees_Form.DO_Adminision,fees_Form.Amount from fees_Form inner join studentdata on fees_Form.Student_Name_Id=studentdata.Student_id inner join studentclass on fees_Form.Class_St_ID=studentclass.Class_id inner join StudentMonths on fees_Form.Month_ID=StudentMonths.Month_ID", con.opencon());
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            obj.cmb_class.Text = dataGridView1.Rows[e.RowIndex].Cells[2].Value.ToString();
            obj.cmb_month.Text = dataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString();
            obj.fees_date_of_adminision.Text= dataGridView1.Rows[e.RowIndex].Cells[4].Value.ToString();
            obj.txt_amount.Text= dataGridView1.Rows[e.RowIndex].Cells[5].Value.ToString();
            obj.Show();
