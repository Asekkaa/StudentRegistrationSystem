...
namespace StudentRegistrationSystem
{
    public partial class st_data_display : MaterialSkin.Controls.MaterialForm
    {
        ...
        {
            adpt = new SqlDataAdapter("select studentdata.Student_id, studentdata.FName, studentdata.LName, studentdata.FatherName, studentdata.FatherID, studentdata.Email,studentdata.Mobile,studentdata.DOB,studentdata.DOR, class.ClassName, studentdata.Adress, studentdata.gender, country.CountryName, province.ProvinceName, city.CityName from studentdata inner join class on studentdata.Cls_id=class.Class_id inner join country on studentdata.c_id=country.country_id inner join province on studentdata.p_id=province.province_id inner join city on studentdata.ct_id=city.city_id", con.opencon());
