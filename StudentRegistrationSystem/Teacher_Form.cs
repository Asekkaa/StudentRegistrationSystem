    ...
    public partial class Teacher_Form : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void btn_st_update_teach_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt_teach_name.Text != "" && txt_teach_lname.Text != "" && txt_teach_father_name.Text != "" && txt_teach_id.Text != "" && txt_teach_email.Text != "" && txt_teach_mobile.Text != "" && cmb_teach_exp.Text != "" && txt_teach_address.Text != "" && cmb_country_teach.Text != "" && cmb_province_tech.Text != "" && cmb_city_teach.Text != "")
                {
                    cmd = new SqlCommand(" update teacherdata set TeachName='" + txt_teach_name.Text + "', TeachLastName='" + txt_teach_lname.Text + "',TeachFaterhName='" + txt_teach_father_name.Text + "',TeachID='" + txt_teach_id.Text + "',TeachEmail='" + txt_teach_email.Text + "',TeachMobile='" + txt_teach_mobile.Text + "',TeachDOB='" + DOB + "',Expertise='" + expert_id + "',TeachAdd='" + txt_teach_address.Text + "',TeachGender='" + gender + "',Teachc_id='" + count_id + "',Teachp_id='" + prov_id + "',Teachct_id='" + city_id + "' where Teach_id='" + TeacherDataShow.teach_id + "'", con.opencon());
                    cmd.ExecuteNonQuery();
